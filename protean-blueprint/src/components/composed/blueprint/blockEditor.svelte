...
{#if $editing}
	<div in:fly="{{ x: 50, duration: 200 }}" out:fly="{{ x: 50, duration: 200 }}" class="flex-none flex flex-col w-60 h-full border-l border-base-200 dark:border-base-800 bg-white dark:bg-base-900 mst">
